...
class FetchPostModel:BaseModel{
    ...
    struct DataUserData: Codable {
        let userID: Int?
        var username, email, ipAddress, fname: String?
        let lname, gender, emailCode, language: String?
        var avatar, cover: String?
        let countryID: Int?
        var about, google, facebook, twitter: String?
        let website: String?
        ...
        let url: String?
        var followers, following, favourites, postsCount: Int?
        let timeText: String?
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case uploads, name, uname, url, followers, following, favourites
    ...
    struct UserPostUserData: Codable {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case bSite = "b_site"
            case bSiteAction = "b_site_action"
            case uploads, name, uname, url, edit, followers, following, favourites
            case postsCount = "posts_count"
        }
    }
