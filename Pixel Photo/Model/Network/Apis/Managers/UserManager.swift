...
class UserManager{
    ...
    func authenticateUser(userName: String, password: String,DeviceId:String, completionBlock: @escaping (_ Success:LoginModel.LoginSuccessModel?,_ SessionError:LoginModel.SessionAndServerError?, Error?) ->()){
        ...
        AF.request(API.AUTH_CONSTANT_METHODS.LOGIN_API, method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
            print(API.AUTH_CONSTANT_METHODS.LOGIN_API)
            print(API.SERVER_KEY.serverKey)
    ...
    func saveSettingUser(dict: [String:String], completionBlock: @escaping (_ Success:UpdateProfileModel.UpdateProfileSuccessModel?,_ SessionError:RegisterModel.SessionAndServerError?, Error?) ->()){
        ...
        log.verbose("Decoded String = \(decoded)")
        AF.request(API.SETTING_CONSTANT_METHODS.SAVE_SETTINGS_API, method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
    ...
    func forgetPassword(email:String, completionBlock: @escaping (_ Success:ForgetPasswordModel.ForgetPasswordSuccessModel?,_ SessionError:ForgetPasswordModel.SessionAndServerError?, Error?) ->()){
        ...
        log.verbose("Decoded String = \(decoded)")
        AF.request(API.AUTH_CONSTANT_METHODS.FORGET_PASSWORD_API, method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
