...
class ChatListVC: BaseVC {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        addUserView.backgroundColor = UIColor.mainColor
    }
    ...
    func setupUI(){
        ...
        self.title = NSLocalizedString("Chats", comment: "Chats")
        ...
        self.showLabel.text = NSLocalizedString("No more Messages", comment: "No more Messages")
...
extension ChatListVC : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.userNameLbl.text = object.userData?.name ?? ""
