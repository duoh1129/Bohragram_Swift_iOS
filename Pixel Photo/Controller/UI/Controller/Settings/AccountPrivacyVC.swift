...
class AccountPrivacyVC: BaseVC {
    ...
    func setupUI(){
        ...
        self.title = NSLocalizedString("Account Privacy", comment: "Account Privacy")
    ...
    func showAudience(){
        ActionSheetStringPicker.show(withTitle: NSLocalizedString("Who can view your profile?", comment: ""),
                                     rows: [NSLocalizedString("Everyone", comment: "Everyone"),NSLocalizedString("Followers", comment: "Followers"),NSLocalizedString("Nobody", comment: "Nobody")],
    ...
    func showDirectMessage(){
        ActionSheetStringPicker.show(withTitle: NSLocalizedString("Who can direct message you?", comment: ""),
                                     rows: [NSLocalizedString("Everyone", comment: "Everyone"),NSLocalizedString("People I follow", comment: "People I follow")],
