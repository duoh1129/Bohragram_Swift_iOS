...
class NotificationSettingsVC: BaseVC {
    ...
    func setupUI(){
        ...
        self.receiveNotificationLbl.text = NSLocalizedString("Received Notification when some one", comment: "")
        ...
        self.title = NSLocalizedString("Notification Setting", comment: "Notification Setting")
