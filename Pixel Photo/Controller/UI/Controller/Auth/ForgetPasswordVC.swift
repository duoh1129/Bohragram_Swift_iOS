...
//        self.forgotPasswordBtn.applyGradient(colours: [UIColor.startColor, UIColor.endColor], start: CGPoint(x: 0.0, y: 1.0), end: CGPoint(x: 1.0, y: 1.0), borderColor: UIColor.clear)
    ...
    func setupUI(){
        ...
        self.pleaseEnterLbl.text = NSLocalizedString("Please enter your email address. We will send you a link to reset password.", comment: "Please enter your email address. We will send you a link to reset password.")
        self.emailTxtFld.placeholder = NSLocalizedString("Email", comment: "")
        self.forgotPasswordBtn.setTitle(NSLocalizedString("SEND", comment: "SEND"), for: .normal)
