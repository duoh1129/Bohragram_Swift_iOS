...
class ShowProfilePostDataVC: BaseVC {
...
extension ShowProfilePostDataVC : UICollectionViewDelegate , UICollectionViewDelegateFlowLayout , UICollectionViewDataSource{
...
extension ShowProfilePostDataVC:IndicatorInfoProvider{
