...
class AddPostPostVC: BaseVC {
    ...
    public override func viewWillAppear(_ animated: Bool) {
        ...
        typeLabel.textColor = UIColor.mainColor
    }
    ...
    private func setupUI(){
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: NSLocalizedString("Post", comment: "Post"), style: .done, target: self, action: #selector(addTapped))
    }
    @objc func addTapped(sender: UIBarButtonItem) {
        if isEmptyMedia!{
            self.view.makeToast(NSLocalizedString("Please select atleast one media.", comment: "Please select atleast one media."))
        }else{
            if type == "GIF" {
    ...
    func setupView(){
        ...
        self.addToPostBtn.setTitle(NSLocalizedString("Add to Post", comment: "Add to Post"), for: UIControl.State.normal)
