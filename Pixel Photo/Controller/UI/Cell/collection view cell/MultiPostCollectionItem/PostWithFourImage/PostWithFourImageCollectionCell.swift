//
//  PostWithFourImageCollectionCell.swift
//  Pixel Photo
//
//  Created by Ubaid Javaid on 8/8/20.
...
class PostWithFourImageCollectionCell: UICollectionViewCell,EditPostDelegate {
    ...
    override func awakeFromNib() {
        ...
        let doubleTap3 = UITapGestureRecognizer(target: self, action: #selector(self.DoubleTap(gesture:)))
        ...
        self.imageView3.addGestureRecognizer(doubleTap2)
        self.imageView4.addGestureRecognizer(doubleTap3)
    ...
    func bind(object: FetchPostModel.UserPost, index:Int){
        ...
        let image3 = object.mediaSet?[2].file ?? ""
        let url2 = URL(string: image3)
        self.imageView3.sd_setImage(with: url2, completed: nil)
        let image4 = object.mediaSet?[3].file ?? ""
        let url3 = URL(string: image4)
        self.imageView4.sd_setImage(with: url3, completed: nil)
